...
saveRDS(data_peaks, paste0(folder,"All_Samples_Binned_Data.RDS")) #this saves the binned data
...
print("Done! - Files are saved in '/QRISdata/Q1851/Andrew_C/Metabolomics/9aa/'")
