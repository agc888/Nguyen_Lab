...
#saveRDS(reduced_ref_data, "I:/GML001-Q1851/Andrew_C/Pfizer/scRNA/Reference_Data/regenerated_ref_data.RDS")
```
...
sc_pipeline <- function(sc_data) {
  ...
  sc_data <- subset(sc_data, subset = nFeature_RNA > 100 & percent.mt < 5)
